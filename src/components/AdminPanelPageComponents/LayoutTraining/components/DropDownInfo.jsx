...
const DropDownInfo = ({ car, price, track, communications, item, hiddenClass }) => {
        ...
        <div className="w-full flex justify-between">
          <div className="w-1/2">
            <div className="border-b py-2">
              ...
              <div>
                ФИО: <span className="font-light">{item.fullName}</span>
              </div>
              <div>
                Способ связи:
              ...
              <div>
                Дата выполнения:
                <span className="font-light">{item.orderDate ? `${inputDate(item.orderDate)} - ${tetHours}: ${tetMinutes}` : "Дата не указана"}</span>
              </div>
            </div>
            <div className="border-b py-2">
          ...
          <div className="w-1/2">
            <div className="border-l border-b py-2 p-2 h-full relative">
              ...
              <div>
                Оборудование: <span className="font-light">{item.equipment}</span>
              </div>
