import DropDownInfo from 'components/AdminPanelPageComponents/LayoutTraining/components/DropDownInfo'
import DropDownUpdate from 'components/AdminPanelPageComponents/LayoutTraining/components/DropDownUpdate'
  ...
  return (
    <>
      <tr className='border-b border-gray-500'>
        ...
        <td>
          {item.orderDate ? inputDate(item.orderDate) : 'Дата не указана'}
        </td>
        <td>
