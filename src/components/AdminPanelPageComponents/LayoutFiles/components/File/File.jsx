	...
	return (
		<>
			<ul className='flex'>
				{filesInfo &&
					filesInfo.map(file => (
						<li key={file._id} className='flex flex-col flex-wrap m-2'>
							<img
								className=' w-80'
							...
							<a href={accessUrl + file.pathFile}>ссылка для скачивания</a>
							<div>
								<button className=' bg-slate-600 m-2 px-2 py-1'>update</button>
								<button
									onClick={() => {
