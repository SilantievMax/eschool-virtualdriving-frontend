					...
					<ul className={styles.list}>
						<li className={styles.item}>
							...
							<p className={styles.description}>
								Перед занятием вы записываете свой реплей с телеметрией и
								отправляете все тренеру. Инструкция по записи телеметрии в REC
								находится ниже.
							</p>
						</li>
						<li className={styles.item}>
							...
							<p className={styles.description}>
								Затем он сравнит эти данные со своими, чтобы начать занятие с
								разбора ошибок. После теоретической части следует практическая,
								на которой тренер будет вас корректировать.
							</p>
						</li>
						<li className={styles.item}>
							<img src={svg3} alt='svg' className={styles.img_svg} />
							<p className={styles.description}>
								Ошибки каждого индивидуальны и зачастую очень сложно
								самостоятельно их выявить. Во время занятия инструктор укажет на
								все недочеты и объяснит как над ними работать, чтобы повысить
								уровень пилотажа.
							</p>
						</li>
					</ul>
