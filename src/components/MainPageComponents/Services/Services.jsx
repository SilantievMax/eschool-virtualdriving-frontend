						...
						<li className={styles.item}>
							...
							<div className={styles.text_card}>
								...
								<p className={styles.description_card}>
									Онлайн тренировка, которая поможет сделать Вас быстрее на
									любой трассе
								</p>
					...
					<Link to={''} title='Подробнее'>
						<li className={styles.item}>
							...
							<div className={styles.text_card}>
								...
								<p className={styles.description_card}>
									Поделимся нашими сетапами или реплеями с телеметрией быстрых
									кругов
								</p>
					...
					<Link to={'/'} title='Подробнее'>
						<li className={styles.item}>
							...
							<div className={styles.text_card}>
								...
								<p className={styles.description_card}>
									Создадим с нуля или воспроизведём по примерам дизайн гоночного
									автомобиля
								</p>
